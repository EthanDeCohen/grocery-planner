...
WINDOWS_INSTALL_DIRNAME = "GroceryPlanner"

#: HKCU, matching the per-user install -- see install.ps1 for why not HKLM.
WINDOWS_REGISTRY_KEY = (
    r"HKCU:\Software\Microsoft\Windows\CurrentVersion\Uninstall\GroceryPlanner"
)

#: Start Menu subfolder. Its own folder so manual cleanup is "delete the folder".
WINDOWS_START_MENU_FOLDER = "Grocery Planner"
...
WINDOWS_TASK_PATH = "\\GroceryPlanner\\"
WINDOWS_TASK_NAME = "Refresh"

#: macOS. The com.grocery-planner.* prefix matches the PyInstaller
...
MACOS_LAUNCH_AGENT_LABEL = "com.grocery-planner.refresh"
MACOS_BUNDLE_IDENTIFIER = "com.grocery-planner.gui"
MACOS_APP_BUNDLE_NAME = "Grocery Planner.app"
...
MACOS_SUPPORT_DIRNAME = ".local/share/grocery-planner"
